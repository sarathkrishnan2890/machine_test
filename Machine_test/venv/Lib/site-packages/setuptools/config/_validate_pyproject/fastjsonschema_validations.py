                ...
                if "optional-dependencies" in data__dynamic_keys:
                    ...
                    if not isinstance(data__dynamic__optionaldependencies, (dict)):
                        raise JsonSchemaValueException(
                            ...
                            definition={'type': 'object', 'propertyNames': {'format': 'python-identifier'},
                                        'additionalProperties': False, 'patternProperties': {
                                ...
                                try:
                                    if isinstance(data__dynamic__optionaldependencies_key, str):
                                        if not custom_formats["python-identifier"](
                                                data__dynamic__optionaldependencies_key):
                                            raise JsonSchemaValueException("" + (
                                                    name_prefix or "data") + ".dynamic.optional-dependencies must be python-identifier",
                                                                           value=data__dynamic__optionaldependencies_key,
                                                                           name="" + (
                                                                                   name_prefix or "data") + ".dynamic.optional-dependencies",
                                                                           definition={'format': 'python-identifier'},
                                                                           rule='format')
                                except JsonSchemaValueException:
